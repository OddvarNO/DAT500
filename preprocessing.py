...
# Code for error: TypeError "Object of type set is not JSON serializable":
    ...
    if url:
        ...
        if len(html) > 0:
            ...
            if parsed_text != None:
                ...
                parsed_text = "".join(parsed_text) # Tokens to string
...
if __name__ == '__main__':
    data = process_warc('/home/ubuntu/cc-mrjob/crawl-data/CC-MAIN-2022-05/segments/1642320299852.23/warc/CC-MAIN-20220116093137-20220116123137-00000.warc.gz', limit = 9000)
    ...
    # Text-format
    # with open("processed_data.txt", "w", encoding="utf8") as text_file:
    #     for entry in data: 
